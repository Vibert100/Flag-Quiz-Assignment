...
Flag_Quiz = {
    ...
    "Question 20": ["Ireland","Russia","India","Malaysia",0,"Flag_images/Irish_Flag.png"],
...
def Question_Generator():
    ...
    if len(Quiz) > 0:
        ...
        Play_Again_Button.pack(pady=(0,20))
        Quit_Button.pack()
...
Quit_Button = Button(main, text="Quit",width="15",
                        font=("arial", 16), bg="#0047AB",
                        bd=0, fg="white", command=Quit_Quiz)
